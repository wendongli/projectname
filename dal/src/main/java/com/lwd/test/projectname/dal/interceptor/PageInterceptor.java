package com.lwd.test.projectname.dal.interceptor;
...
import com.lwd.test.projectname.dal.common.Page;
...
public class PageInterceptor implements Interceptor {
    ...
    private String getMysqlPageSql(Page<?> page, StringBuffer sqlBuffer) {
        int offset = page.getOffset() > 0 ? page.getOffset() : (page.getPageNo() - 1) * page.getPageSize();
